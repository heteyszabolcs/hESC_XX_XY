...
create_edgeR_input = function(mark, bin_size = 10000) {
  ...
  norm = input_normalization(mark = mark, input = input, bin_size = bin_size)
...
# save
write_tsv(input_norm_data, glue("{result_path}input_normalized_{bin_size}kbp.tsv"))
